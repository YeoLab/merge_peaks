...
my $command1 = "perl /home/bay001/projects/codebase/merge_peaks/current/overlap_peakfi_with_bam_PE.pl $bamfi_rep1 $bamfi_input1 $output_bed $mapped_readnum_fi $rep1_inputnorm_output";
print STDERR "command1 $command1\n";
system("perl /home/bay001/projects/codebase/merge_peaks/current/overlap_peakfi_with_bam_PE.pl $bamfi_rep1 $bamfi_input1 $output_bed $mapped_readnum_fi $rep1_inputnorm_output") unless (-e $rep1_inputnorm_output);
my $command2 = "perl /home/bay001/projects/codebase/merge_peaks/current/overlap_peakfi_with_bam_PE.pl $bamfi_rep2 $bamfi_input2 $output_bed $mapped_readnum_fi $rep2_inputnorm_output";
print STDERR "command2 $command2\n";
system("perl /home/bay001/projects/codebase/merge_peaks/current/overlap_peakfi_with_bam_PE.pl $bamfi_rep2 $bamfi_input2 $output_bed $mapped_readnum_fi $rep2_inputnorm_output") unless (-e $rep2_inputnorm_output);
