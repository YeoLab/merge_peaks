...
outputs:
  ...
  wf_rescue_ratio_1input_split_rep1_clip_read_num:
    type: File
    outputSource: step_split_merged_bam_and_idr/wf_split_self_and_idr_rep1_clip_read_num
  wf_rescue_ratio_1input_split_rep2_clip_read_num:
    type: File
    outputSource: step_split_merged_bam_and_idr/wf_split_self_and_idr_rep2_clip_read_num
  wf_rescue_ratio_1input_rep1_input_read_num:
    type: File
    outputSource: step_split_merged_bam_and_idr/wf_split_self_and_idr_rep1_input_read_num
  wf_rescue_ratio_1input_rep2_input_read_num:
    type: File
    outputSource: step_split_merged_bam_and_idr/wf_split_self_and_idr_rep2_input_read_num
  wf_rescue_ratio_1input_pseudo_reproducible_peaks:
    type: File
    outputSource: step_split_merged_bam_and_idr/wf_split_self_and_idr_merged_peaks_bed_file
...
steps:
  ...
  step_split_merged_bam_and_idr:
    ...
    out:
      - wf_split_self_and_idr_rep1_clip_read_num  # DEBUG
      - wf_split_self_and_idr_rep2_clip_read_num  # DEBUG
      - wf_split_self_and_idr_rep1_input_read_num  # DEBUG
      - wf_split_self_and_idr_rep2_input_read_num  # DEBUG
      - wf_split_self_and_idr_merged_peaks_bed_file  # DEBUG
  ...
  step_rescue_ratio:
    ...
    in:
      ...
      count2: step_split_merged_bam_and_idr/wf_split_self_and_idr_reproducing_peaks_count
      output_file: 
