...
doc: |
  ...
  to wf_full_IDR_pipeline_2inputs.cwl
...
steps:
  ...
  wf_full_IDR_pipeline_2inputs:
    run: wf_full_IDR_pipeline_2inputs.cwl
    in:
      rep1_name: step_parse_sample_IDR/rep1_name
      rep1_clip_bam_file: step_parse_sample_IDR/rep1_ip_bam
      rep1_input_bam_file: step_parse_sample_IDR/rep1_input_bam
      ...
      rep2_input_bam_file: step_parse_sample_IDR/rep2_input_bam
